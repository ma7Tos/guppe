...
OBS.: Sobre dicionários
    - Chave e valor são pserados por dois pontos "chave:valor";
...
print(paises['br'])
# print(paises['ru'])
# OBS.: Caso tentemos fazer um acesso utilizando uma chave que não existe teremos um KeyError
...
localidades = {
    ...
    (45.6895, 74.6917): 'Escritório em NY',
    (37.6895, 122.6917): 'Escritório em SP',
}
...
# A forma de adicionar novos elementos ou atualizar dados é a mesma.
...
# OBS 2.: Ao removermos um objeto, o valor deste é sempre retornado.
...
--------------------------------------------------------------------------------------------------------------
# Imagina que você tem um comércio eletrônico, onde temos um carrinho de compras na qual adicionamos produtos.
...
# O metodo fromkeys recebe dois parêmtros: um iterável e um valor.
