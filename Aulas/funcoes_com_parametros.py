...
- Funções que recebem dados para serem proessados dentro da mesma;

Se a gente pensar em um programa qualquer, geralemnte temos:

entrada -> processamento -> saída

Se a gente pensar em uma função, já samos que temos funções que:
-Não possuem entrada;
-Não possuem saída;
...
#Caso utilizemos nomes dos parâmetros nos agumentos para informá-los, podemos utilizar qualquer ordem.
