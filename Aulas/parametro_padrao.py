...
# Exemplo de função one a passagem de parâmetro seja obrigatória
...
# Se o usuário passar 2 argumentos, o primeiro será atribuído ao prâmetro numero e o seugundo ao parâmetro potencia.
# Então será calculada esta potência.

print(exponencial())

# OBS.: Em funções Python, os parâmetros com valores default (padrão) DVEM sempre estar ao final da declaração.
...
- Nosp ermite trabalhar com exemplos mais legíveis de código;

# Quais tipos de dados podemos utilizar como valores default para parâmetros?

- Qualquee tipo de dado:
